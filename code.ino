...
String apiKey = "457TVFDS1Q3WXRQU";
...
String AP = "TP-Link_75FB_5G";       // AP NAME
String PASS = "bashar#1";
...
String cmd="AT+CWJAP=\"TP-Link_75FB_5G\",\"bashar#1\"";
...
void esp_8266()
{
// TCP connection AT+CIPSTART=4,"TCP","192.168.0.181",80
